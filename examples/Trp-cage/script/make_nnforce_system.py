...
for weight_decay in weight_decay_list:
    ...
    traced_nnforce.save(f"./output/{name}/FF/full_rmsd_{full_include_rmsd}_weight_decay_{full_weight_decay}_NNForceXYZ_weight_decay_{weight_decay:.3E}.pth")

    nnforce = TorchForce(f"./output/{name}/FF/full_rmsd_{full_include_rmsd}_weight_decay_{full_weight_decay}_NNForceXYZ_weight_decay_{weight_decay:.3E}.pth")
    ...
    with open(f"./output/{name}/nnforce_system/full_rmsd_{full_include_rmsd}_weight_decay_{full_weight_decay}_NNForce_weight_decay_{weight_decay:.3E}.xml", 'w') as file_handle:
