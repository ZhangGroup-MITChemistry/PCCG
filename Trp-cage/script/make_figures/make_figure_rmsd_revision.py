...
traj_cg_nn = mdtraj.load_dcd(f"./output/{name}/nnforce_NVT/full_rmsd_False_weight_decay_4e-07_weight_decay_{1e-3:.3E}_different_initial_parameters.dcd", psf)
...
fig = plt.figure(np.random.randint(0, 1000), figsize = (6.4*2, 4.8))
fig.clf()
plt.subplot(1,2,1)
...
fig.savefig("./output/plots/2JOF_rmsd_hist_different_initial_parameters.eps")
fig.savefig("./output/plots/2JOF_rmsd_hist_different_initial_parameters.pdf")
