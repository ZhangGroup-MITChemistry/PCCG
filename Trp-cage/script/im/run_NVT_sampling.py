...
#SBATCH --output=./slurm_output/NVT_IM.txt
...
os.makedirs(f"./output/{name}/im/CG_simulations/", exist_ok = True)
file_handle = open(f"./output/{name}/im/CG_simulations/traj.dcd", 'wb')
